...
public class MvcExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public MvcExceptionHandler(DocumentTypeParameters documentTypeParameters) {
        this.documentTypeParameters = documentTypeParameters;
    }
    ...
    public ResponseEntity<ApiError> validationErrorHandler(DocumentTypeException ame) {
        ApiError apiError = ApiError
                .builder()
                .timestamp(LocalDateTime.now())
                .api(documentTypeParameters.getApi())
